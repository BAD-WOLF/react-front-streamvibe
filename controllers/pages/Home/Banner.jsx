            ...
            <div className="flex flex-col justify-center items-center z-10 px-8 md:px-4">
                <div className=" text-gray-200 flex flex-col gap-4">
                    ...
                    <form className='relative flex justify-center items-center'>
                        <input type='search' placeholder='Pesquisar por films, series ou nome de um autor' className='w-full py-2 px-6 pr-8 text-lg text-gray-600 font-light placeholder:text-base placeholder:text-gray-400 placeholder:font-light rounded-full'/>
