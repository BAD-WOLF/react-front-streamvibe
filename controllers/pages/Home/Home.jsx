...
export default function Home(){
    ...
    const testimonials = [
        ...
        { quote: "Se você ama filmes e séries tanto quanto eu, esse site é perfeito! As análises e sugestões são sempre certeiras!", name: "Goreth Antonio", designation: "Visitante", src: goreth },

        { quote: "Uma experiência cinematográfica incrível! Cada filme e série  aqui me surpreenderam. Não perco mais tempo escolhendo o que assistir!", name: "Laurinda Andre", designation: "Visitante", src:lau },

        { quote: "Se você ama filmes e séries tanto quanto eu, esse site é perfeito! As análises e sugestões são sempre certeiras!", name: "Maria Paulin", designation: "Visitante", src: maria },
